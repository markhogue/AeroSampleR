---
title: "AeroSampleR_vignette"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{AeroSampleR_vignette}
...
### 3) Set up the parameters for tube size, flow rate, temperature, and pressure. These parameters are not particle dependent and so can be kept in a samll separate data frame.
